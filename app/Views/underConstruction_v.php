...
<div class="card-box p-5">
    <h2 class="text-uppercase text-center pb-4">
        <a href="index.html" class="text-success">
            <span><img src="<?= base_url('logo'); ?>/logo.png" alt="" height="26"></span>
        </a>
    </h2>
    ...
    <div class="text-center">
        ...
        <h4 class="text-danger">Aplikasi dalam proses pengembangan</h4>
        <p class="text-muted">Mohon maaf halaman belum tersedia. Tim kami sedang bekerja untuk memberikan yang terbaik untuk anda..</p>
    </div>
